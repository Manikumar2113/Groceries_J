    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spinner1.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                if (selectedItem != "Pineapple") {
                    ...
                    Toast.makeText(this@Fruits, "$selectedItem - Price: $price", Toast.LENGTH_SHORT).show()
                }
        ...
        completeButton.setOnClickListener {
            ...
            if (selectedProcessor == "Processors" || selectedGraphicsCard == "Graphics Cards" || selectedRAM == "Ram" ||
                ...
                Toast.makeText(this@Fruits, "Please complete the build by selecting options for all components.", Toast.LENGTH_SHORT).show()
            } else {
                val intent = Intent(this@Fruits, Report::class.java)
                intent.putExtra("Pineapple", selectedProcessor)
                intent.putExtra("Orange", selectedGraphicsCard)
                intent.putExtra("Kiwi", selectedRAM)
                intent.putExtra("PassionFruit", selectedMotherboard)
                intent.putExtra("Pears", selectedSSD)
                intent.putExtra("Peach", selectedPowerSupply)
